...
compile_tool linux-x86_64 elf juicer ../peel/src/juicer/juicer.jabara
compile_tool linux-x86_64 elf concat ../peel/src/concat/concat.jabara
compile_tool linux-x86_64 elf pish ../peel/src/pish/pish.jabara

compile_orgasm windows-x86_64 exe
compile_tool windows-x86_64 exe juicer ../peel/src/juicer/juicer.jabara
compile_tool windows-x86_64 exe concat ../peel/src/concat/concat.jabara
compile_tool windows-x86_64 exe pish ../peel/src/pish/pish.jabara

compile_orgasm fruityos-x86_64 fap
compile_tool fruityos-x86_64 fap juicer ../peel/src/juicer/juicer.jabara
compile_tool fruityos-x86_64 fap concat ../peel/src/concat/concat.jabara
compile_tool fruityos-x86_64 fap pish ../peel/src/pish/pish.jabara
