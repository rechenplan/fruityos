...
echo Compiling pish.yuzu...
../yuzu/bin/yc src/pish.yuzu tmp/pish.asm
...
cat src/entry.asm src/idt.asm tmp/kmain.asm tmp/pish.asm tmp/idt.asm tmp/sys.asm tmp/x86.asm tmp/utils.asm tmp/ramfs.asm tmp/fba.asm tmp/list.asm tmp/inode.asm tmp/heap.asm tmp/global.asm tmp/scr.asm tmp/kb.asm tmp/fd.asm tmp/page.asm > tmp/pulp.asm
