...
- Haruka compiles the `.hr` kernel to Sol, and Phobos emits the region
...
Phobos first exports generated symbols for Orgasm. Orgasm then exports
handwritten symbols for the final Phobos pass. The assembly prefix is
size-checked, padded to
exactly 4,608 bytes, and concatenated with the Phobos output. The build writes:
